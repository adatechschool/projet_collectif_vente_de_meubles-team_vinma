...
<div class="flex p-6 ">
    ...
    <div class="w-2/5">
        ...
        <button type="submit" class="hover:bg-amber-500 bg-amber-400 w-4/5 m-3 p-4 text-lg rounded">Add to Cart</button>
        <h2 class= "font-medium text-4xl text-stone-800 mx-3">Product description</h2>
        <p class="text-xl text-stone-800 mx-3">Les bois durs sont considérés comme la qualité maximale et sont les plus chers. 
            Leurs couleurs naturelles varient des bois les plus profonds aux bois les plus 
            légers et ils peuvent être teints ou peints pour plus de diversité.</p>
        <button 
...
<div>
    <h2 class= "font-medium text-4xl text-stone-800 m-4 pt-4">You will like also</h2>
    <div class="flex m-8 text-center pb-4 ">
    <div class="border w-1/5 h-85 mx-4 bg-white p-4">
        <a href="#" target="_blank"><img src={require("./meuble.jpg")} alt="photo"/></a>
...
<div>
    <h2 class= "font-medium text-4xl text-stone-800 m-4 pt-4">Others also liked</h2>
