...
export default function ModifyAddress({infosModified}) {
    ...
    return (
        ...
        <div className="flex flex-col rounded border-gray-100 shadow-sm bg-white py-4 px-4 space-y-4">
            <div>
                <h1 className="text-2xl font-bold text-cyan-500">change my address</h1>
                <p className="font-bold">update your address</p>
            </div>
            <div>
                <p>change address</p>
                <input className="border border-black w-48" type="text" value={newAdress} onChange={(e)=>setNewAddress(e.target.value)}/>
            </div>
